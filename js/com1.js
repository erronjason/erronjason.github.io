...
COMMANDS.cat =  function(argv, cb) {
   ...
   filenames.forEach(function(filename, i) {
      ...
      if (!entry)
         ...
         this._terminal.write('<br>' + entry.contents + '<br>');
...
COMMANDS.help = function(argv, cb) {
   this._terminal.write(
       '\nYou can navigate the filesystem by clicking anything that ' +
       '<a href="javascript:void(0)">underlines</a> upon mouseover,' +
       ' or via typing commands into the terminal. Type the name of a ' +
       '<span class="exec">link</span> to view it. Use "cd" to change into a ' +
       '<span class="dir">directory</span>, or "ls" to list the contents ' +
       'of that directory. The contents of a <span class="text">file</span> ' +
       'can be viewed using "cat". <span class="img">Images</span> are ' +
       'displayed using "gimp".<br><br>If there is a command you want to cancel,' +
       'press Ctrl+C or Ctrl+D.<br><br>');
